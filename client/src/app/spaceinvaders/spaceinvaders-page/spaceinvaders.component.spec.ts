...
import { SpaceinvadersComponent } from './spaceinvaders.component';
...
describe('SpaceinvadersComponent', () => {
    ...
    describe('game unable to be joined', () => {
        let playGameSpy: jasmine.Spy;
        ...
        // it('should alert too many players', () => {
    ...
    describe('when game over', () => {
        ...
        it('should allow rematch button to be clickable', () => {
            ...
            expect(component.spaceinvadersHomeButtonDisabled == false);
