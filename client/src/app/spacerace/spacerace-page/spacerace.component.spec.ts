...
import { SpaceraceComponent } from './spacerace.component';
import { Router } from '@angular/router';

describe('SpaceraceComponent', () => {
    let component: SpaceraceComponent;
    let fixture: ComponentFixture<SpaceraceComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            declarations: [SpaceraceComponent],
            providers: [Router]
        })
            .compileComponents();
    });
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(SpaceraceComponent);
    ...
    describe('when game over', () => {
        ...
        it('should allow rematch button to be clickable', () => {
            ...
            expect(component.spaceraceHomeButtonDisabled == false);
